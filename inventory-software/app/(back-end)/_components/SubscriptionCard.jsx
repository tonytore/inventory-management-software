...
const SubscriptionCard = () => {
  return (
    <div className='flex flex-col rounded-lg dark:bg-slate-900 my-9 mx-3'>
      <div className=''>
            <p className='border-l-4 text-wrap text-sm my-1 mx-2 py-2 px-2 border-orange-300'>Your Premium plans trial expires in <span className='text-orange-600 text-xs'>14 days.</span></p>
      </div>
